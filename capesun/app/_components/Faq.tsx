        ...
        <section className="py-10 bg-primary sm:py-16 lg:py-24">
            <div className=" mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="max-w-2xl mx-auto text-left">
                    <h2 className="text-2xl font-bold leading-tight text-accent sm:text-4xl lg:text-5xl">Our clients include</h2>
                </div>

                <div className="max-w-3xl mx-auto mt-8 space-y-4 md:mt-16">
                    {faq.map((item, index) => (
                        <div key={index} className="transition-all duration-200 bg-primary border border-primary cursor-pointer hover:bg-accent">
                            ...
                            <div className={`${item.open ? 'block' : 'hidden'} px-4 pb-5 sm:px-6 sm:pb-6 text-white`}>
